...
search.addWidget(
	instantsearch.widgets.sortBy({
		  ...
		  items: [
		    ...
		    { label: 'Price (lowest)', value: 'Bordeaux_price_asc' },
		    { label: 'Price (highest)', value: 'Bordeaux_price_desc' },
		    { label: 'Quality (lowest)', value: 'Bordeaux_quality_asc' },
		    { label: 'Quality (highest)', value: 'Bordeaux_quality_desc' },
		  ],
	})
);
